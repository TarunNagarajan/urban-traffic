...
SUMO_CONFIG = {
    ...
    "net_file": os.path.join(os.path.dirname(sumo_rl.__file__), "nets", "4x4-Lucas", "4x4.net.xml"),
    "route_file": os.path.join(os.path.dirname(sumo_rl.__file__), "nets", "4x4-Lucas", "4x4c1.rou.xml"),
    "num_seconds": 900,
    "delta_time": 5,
    "yellow_time": 2,
    "min_green": 10,
    "gui": False,  # GUI Enabled for Demonstration
